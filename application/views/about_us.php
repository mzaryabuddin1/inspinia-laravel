					...
					<div class="tt-col-lg-9">
						<div class="text-xlg anim-fadeinup">
							<div class="tt-heading tt-heading-lg margin-bottom-60">
								<h2 class="tt-heading-title">Hey y'all!</h2>
							</div>
							<p>We are a passionate team driven by creativity, innovation, and a relentless pursuit of excellence. Our journey is defined by crafting extraordinary digital experiences and delivering solutions that transform ideas into reality.</p>

							<p>In our vibrant culture of collaboration, every challenge is an opportunity, and every idea is a spark waiting to ignite. Whether it's designing seamless UI/UX, building dynamic websites, or developing cutting-edge mobile applications, we strive to redefine the boundaries of possibility.</p>
							<p>With a steadfast focus on quality and client satisfaction, we welcome every opportunity to grow, evolve, and create something truly remarkable together.</p>
						</div>
					</div>
				...
				<div class="tt-row">
					<div class="tt-col-lg-5">
						<div class="tt-heading tt-heading-lg margin-bottom-60 anim-fadeinup">
							...
							<h2 class="tt-heading-title">What<br> Customers<br> Say</h2>
						</div>
					</div>
		...
		<div class="tt-section padding-top-xlg-150 padding-bottom-xlg-150">
			<div class="tt-section-inner tt-wrap">
				<div class="tt-heading tt-heading-lg tt-heading-center margin-bottom-120 anim-fadeinup">
					<h2 class="tt-heading-title">Clients We<br> Stand For</h2>
				</div>
