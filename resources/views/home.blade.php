...
<head>
    <title>Liveasoft - Limitless Transformation</title>
    <meta charset="utf-8">
    ...
    <link rel="stylesheet" href="{{ asset('theme/assets/vendor/normalize/normalize.min.css') }}">
    <link rel="stylesheet" href="{{ asset('theme/assets/vendor/fontawesome/css/fontawesome-all.min.css') }}">
    <link rel="stylesheet" href="{{ asset('theme/assets/vendor/swiper/css/swiper-bundle.min.css') }}">
    <link rel="stylesheet" href="{{ asset('theme/assets/vendor/lightgallery/css/lightgallery.min.css') }}">
    <link rel="stylesheet" href="{{ asset('theme/assets/css/helper.css') }}">
...
<body id="body" class="tt-transition tt-boxed tt-smooth-scroll tt-magic-cursor">
        ...
        <div id="page-transition">
            ...
            <div class="ptr-preloader">
                <div class="ptr-prel-content">
                    <img src="{{ asset('theme/assets/img/logo-light.png') }}" class="ptr-prel-image tt-logo-light"
                        alt="Logo">
                </div>
            </div>
        </div>
            ...
            <header id="tt-header" class="tt-header-fixed">
                <div class="tt-header-inner">
                    <div class="tt-header-col">
                        <div class="tt-logo">
                            <a href="index.html">
                                <img src="{{ asset('theme/assets/img/logo-light.png') }}"
                                    class="tt-logo-light magnetic-item" alt="Logo">
                                <img src="{{ asset('theme/assets/img/logo-dark.png') }}"
                                    class="tt-logo-dark magnetic-item" alt="Logo">
                            </a>
                        </div>
                    </div>
                    <div class="tt-header-col">
                                            ...
                                            <li class="tt-ol-submenu-wrap">
                                                ...
                                                <div class="tt-ol-submenu">
                                                    <ul class="tt-ol-submenu-list">
                                                        <li class="tt-ol-submenu-wrap">
                                                            <div class="tt-ol-submenu-trigger">
                                                                <a href="#" class="tt-ol-submenu-link">Blog
                                                                    List</a>
                                                                <div class="tt-ol-submenu-caret-wrap">
                                                                    <div class="tt-ol-submenu-caret magnetic-item">
                                                                    </div>
                                                            ...
                                                            <div class="tt-ol-submenu">
                                                                <ul class="tt-ol-submenu-list">
                                                                    ...
                                                                    <li><a href="blog-classic-sidebar.html">Classic
                                                                            Sidebar</a></li>
                                                                    <li><a href="blog-compact.html">Compact List</a>
                                                                    </li>
                                                            ...
                                                            <div class="tt-ol-submenu">
                                                                <ul class="tt-ol-submenu-list">
                                                                    ...
                                                                    <li><a href="blog-post-classic-sidebar.html">Classic
                                                                            Sidebar</a></li>
                                                                    <li><a href="blog-post-no-featured-image.html">No
                                                                            Featured Image</a></li>
                                                                </ul>
                                                            </div>
                                                        </li>
                ...
                <div id="page-content">
                                                ...
                                                <div class="portfolio-grid-item">
                                                        ...
                                                        <div class="pgi-image-holder">
                                                            <div class="pgi-image-inner anim-zoomin">
                                                                <figure class="pgi-image ttgr-height">
                                                                    <img src="{{ asset('theme/assets/img/portfolio/1200/portfolio-1.jpg')}}"
                                                                        alt="image">
                                                                </figure>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="pgi-caption">
                                                        <div class="pgi-caption-inner">
                                                            <h2 class="pgi-title">
                                                                <a href="single-project-1.html">E-CRM</a>
                                                            </h2>
                                                            <div class="pgi-categories-wrap">
                                                                <div class="pgi-category">Customer Relationship Management</div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="portfolio-grid-item">
                                                    <a href="single-project-2.html" class="pgi-image-wrap"
                                                        ...
                                                        <div class="pgi-image-holder">
                                                            <div class="pgi-image-inner anim-zoomin">
                                                                <figure class="pgi-image ttgr-height">
                                                                    <img src="{{ asset('theme/assets/img/portfolio/1200/portfolio-2.jpg')}}"
                                                                        alt="image">
                                                                </figure>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="pgi-caption">
                                                        <div class="pgi-caption-inner">
                                                            <h2 class="pgi-title">
                                                                <a href="single-project-2.html">Sale On Air</a>
                                                            </h2>
                                                            <div class="pgi-categories-wrap">
                                                                <div class="pgi-category">Point Of Sale</div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="ttgr-item-inner">
                                                <div class="portfolio-grid-item">
                                                        ...
                                                        <div class="pgi-image-holder">
                                                            <div class="pgi-image-inner anim-zoomin">
                                                                <figure class="pgi-video-wrap ttgr-height">
                                                                    <video class="pgi-video" loop muted
                                                                        preload="metadata"
                                                                        poster="{{ asset('theme/assets/vids/fashion-shoot.jpg')}}">
                                                                        <source src="{{ asset('theme/assets/vids/fashion-shoot.mp4')}}"
                                                                            type="video/mp4">
                                                                        <source src="{{ asset('theme/assets/vids/fashion-shoot.webm')}}"
                                                                            type="video/webm">
                                                                    </video>
                                                                </figure>
                                                            </div>
                                                    ...
                                                    <div class="pgi-caption">
                                                        <div class="pgi-caption-inner">
                                                            <h2 class="pgi-title">
                                                                <a href="single-project-3.html">Creatives</a>
                                                            </h2>
                                                            <div class="pgi-categories-wrap">
                                                                <div class="pgi-category">Digital Marketing</div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="portfolio-grid-item">
                                                    <a href="single-project-4.html" class="pgi-image-wrap"
                                                        ...
                                                        <div class="pgi-image-holder">
                                                            <div class="pgi-image-inner anim-zoomin">
                                                                <figure class="pgi-image ttgr-height">
                                                                    <img src="{{ asset('theme/assets/img/portfolio/1200/portfolio-3.jpg') }}"
                                                                        alt="image">
                                                                </figure>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="pgi-caption">
                                                        <div class="pgi-caption-inner">
                                                            <h2 class="pgi-title">
                                                                <a href="single-project-4.html">Deepfake</a>
                                                            </h2>
                                                            <div class="pgi-categories-wrap">
                                                                <div class="pgi-category">Face Swap</div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="scr-btn-spinner">
                                            <svg viewBox="0 0 500 500">
                                                ...
                                                <text dy="30" class="scr-btn-text">
                                                    <textPath xlink:href="#textcircle">All Products - All Products -
                                                    </textPath>
                                                </text>
                                            </svg>
                                        </div>
                    ...
                    <div class="tt-section padding-top-xlg-120 padding-bottom-xlg-120 bg-white-accent-3">
                        <div class="tt-section-inner">
                            <div class="tt-scrolling-text" data-scroll-speed="10">
                                <div class="tt-scrolling-text-inner"
                                    data-text="We are trusted by clients worldwide →">
                                    We are trusted by clients worldwide →
                                </div>
                            </div>
                            <div class="tt-scrolling-text scr-text-stroke scr-text-reverse" data-scroll-speed="10">
                                <div class="tt-scrolling-text-inner" data-text="More than half decade experience →">
                                    More than half decade experience →
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <ul class="tt-logo-wall anim-fadeinup">
                                <li>
                                    <a href="https://liveasoft.com/" class="cursor-alter" target="_blank"
                                        rel="noopener">
                                        <img src="{{ asset('theme/assets/img/clients/client-1-light.png')}}" class="lv-client-light"
                                            alt="Client">
                                        <img src="{{ asset('theme/assets/img/clients/client-1-dark.png')}}" class="lv-client-dark"
                                            alt="Client">
                                    </a>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a href="https://liveasoft.com/" class="cursor-alter" target="_blank"
                                        rel="noopener">
                                        <img src="assets/img/clients/client-6-light.png" class="lv-client-light"
                                            alt="Client">
                                        <img src="assets/img/clients/client-6-dark.png" class="lv-client-dark"
                                            alt="Client">
                                    </a>
                                </li>
                                <li>
                                    <a href="https://liveasoft.com/" class="cursor-alter" target="_blank"
                                        rel="noopener">
                                        <img src="assets/img/clients/client-7-light.png" class="lv-client-light"
                                            alt="Client">
                                        <img src="assets/img/clients/client-7-dark.png" class="lv-client-dark"
                                            alt="Client">
                                    </a>
                                </li>
                                <li>
                                    <a href="https://liveasoft.com/" class="cursor-alter" target="_blank"
                                        rel="noopener">
                                        <img src="assets/img/clients/client-8-light.png" class="lv-client-light"
                                            alt="Client">
                                        <img src="assets/img/clients/client-8-dark.png" class="lv-client-dark"
                                            alt="Client">
                                    </a>
                                </li>
                                <li>
                                    <a href="https://liveasoft.com/" class="cursor-alter" target="_blank"
                                        rel="noopener">
                                        <img src="assets/img/clients/client-9-light.png" class="lv-client-light"
                                            alt="Client">
                                        <img src="assets/img/clients/client-9-dark.png" class="lv-client-dark"
                                            alt="Client">
                                    </a>
                                </li>
                                <li>
                                    <a href="https://liveasoft.com/" class="cursor-alter" target="_blank"
                                        rel="noopener">
                                        <img src="assets/img/clients/client-10-light.png" class="lv-client-light"
                                            alt="Client">
                                        <img src="assets/img/clients/client-10-dark.png" class="lv-client-dark"
                                            alt="Client">
                                    </a>
                                </li>
                            </ul>
                    ...
                    <div class="tt-section padding-top-xlg-150 padding-bottom-xlg-150 bg-white-accent-3">
                        <div class="tt-section-inner tt-wrap max-width-1600">
                            <div
                                class="tt-heading tt-heading-xlg margin-bottom-7-p anim-fadeinup max-width-1250 margin-auto">
                                        ...
                                        <div class="swiper-slide">
                                            <div class="tt-blog-carousel-item">
                                                ...
                                                <div class="tt-bci-info">
                                                    ...
                                                    <h2 class="tt-bci-title"><a href="blog-post.html">5 Surprising
                                                            Techniques to Improve Your Creativity</a></h2>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="tt-blog-carousel-item">
                                                <a href="blog-post.html" class="tt-bci-image-wrap"
                                                    ...
                                                    <figure class="tt-bci-image">
                                                        <img class="swiper-lazy" src="assets/img/low-qlt-thumb.jpg"
                                                            data-src="assets/img/blog/carousel/blog-carousel-2.jpg"
                                                            alt="Image">
                                                    </figure>
                                                </a>
                                                <div class="tt-bci-info">
                                                    ...
                                                    <h2 class="tt-bci-title"><a href="blog-post.html">Avoid the Top 10
                                                            Mistakes Made by Beginners</a></h2>
                                                    <div class="tt-bci-meta">
                                        ...
                                        <div class="swiper-slide">
                                            <div class="tt-blog-carousel-item">
                                                <a href="blog-post.html" class="tt-bci-image-wrap"
                                                    ...
                                                    <figure class="tt-bci-image">
                                                        <img class="swiper-lazy" src="assets/img/low-qlt-thumb.jpg"
                                                            data-src="assets/img/blog/carousel/blog-carousel-3.jpg"
                                                            alt="Image">
                                                    </figure>
                                                </a>
                                                <div class="tt-bci-info">
                                                    ...
                                                    <h2 class="tt-bci-title"><a href="blog-post.html">Why Some People
                                                            Save Money With This Method</a></h2>
                                                    <div class="tt-bci-meta">
                                        ...
                                        <div class="swiper-slide">
                                            <div class="tt-blog-carousel-item">
                                                <a href="blog-post.html" class="tt-bci-image-wrap"
                                                    ...
                                                    <figure class="tt-bci-image">
                                                        <img class="swiper-lazy" src="assets/img/low-qlt-thumb.jpg"
                                                            data-src="assets/img/blog/carousel/blog-carousel-4.jpg"
                                                            alt="Image">
                                                    </figure>
                                                </a>
                                                <div class="tt-bci-info">
                                                    ...
                                                    <h2 class="tt-bci-title"><a href="blog-post.html">Want to Step Up
                                                            Your Skills? You Need to Read This First</a></h2>
                                                    <div class="tt-bci-meta">
                                        ...
                                        <div class="swiper-slide">
                                            <div class="tt-blog-carousel-item">
                                                <a href="blog-post.html" class="tt-bci-image-wrap"
                                                    ...
                                                    <figure class="tt-bci-image">
                                                        <img class="swiper-lazy" src="assets/img/low-qlt-thumb.jpg"
                                                            data-src="assets/img/blog/carousel/blog-carousel-5.jpg"
                                                            alt="Image">
                                                    </figure>
                                                </a>
                                                <div class="tt-bci-info">
                                                    ...
                                                    <h2 class="tt-bci-title"><a href="blog-post.html">Secrets to
                                                            Getting
                                                            Your Project to Complete Quickly</a></h2>
                                                    <div class="tt-bci-meta">
                        ...
                        <div class="footer-col tt-align-center order-m-last">
                            <div class="footer-col-inner">
                                <div class="tt-copyright text-gray">
                                    <a href="https://liveasoft.com" target="_blank" rel="noopener"
                                        class="tt-btn tt-btn-link">
                                        <span class="tt-btn-icon"><i class="far fa-copyright"></i></span>
                                        <div data-hover="liveasoft.com">liveasoft.com</div>
                                    </a>
                                </div>
                            </div>
                        </div>
    ...
    <script src="{{ asset('theme/assets/vendor/gsap/gsap.min.js') }}"></script>
    <script src="{{ asset('theme/assets/vendor/gsap/ScrollToPlugin.min.js') }}"></script>
    <script src="{{ asset('theme/assets/vendor/gsap/ScrollTrigger.min.js') }}"></script>
    <script src="{{ asset('theme/assets/vendor/smooth-scrollbar.js') }}"></script>
    <script src="{{ asset('theme/assets/vendor/swiper/js/swiper-bundle.min.js') }}"></script>
    <script src="{{ asset('theme/assets/vendor/isotope/imagesloaded.pkgd.min.js') }}"></script>
    <script src="{{ asset('theme/assets/vendor/isotope/isotope.pkgd.min.js') }}"></script>
    <script src="{{ asset('theme/assets/vendor/isotope/packery-mode.pkgd.min.js') }}"></script>
    <script src="{{ asset('theme/assets/vendor/lightgallery/js/lightgallery-all.min.js') }}"></script>
    <script src="{{ asset('theme/assets/vendor/jquery.mousewheel.min.js') }}"></script>
